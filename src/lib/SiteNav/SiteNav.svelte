...
<nav class="flex flex-col order-last md:order-first justify-end z-40 h-full max-w-6 bg-black border-bprimary/80 pr-2 border-l-2 md:pr-0 md:pl-2 md:justify-start md:border-l-0 md:border-r-2">
