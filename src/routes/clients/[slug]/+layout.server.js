...
export async function load ({params}) {
  const url = `/api/clients?filters[slug][$eq]=${params.slug}&populate[presses][fields][0]=title&populate[presses][fields][1]=slug&populate[presses][populate][0]=logo&populate[works][fields][0]=title&populate[works][fields][1]=slug&populate[works][fields][2]=vimeoUrl&populate[works][populate][0]=client`
